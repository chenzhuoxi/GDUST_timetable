...
> 📱 **抓取完课表后**，推荐配合 [广科课表 Full](https://github.com/chenzhuoxi/GDUST_timetable_full)（内置 CAS 登录 + 自动抓取 + 课前提醒）或 [Lite 版](https://github.com/chenzhuoxi/GDUST_timetable_lite)（导入 JSON 查看）在手机上随时查看。
...
```json
{
  ...
  "year": "2025",                  ← 入学年份（教务系统显示的年份）
  "semester": "12",                ← 学期：12=第一学期，03=第二学期
...
- [GDUST_timetable_full](https://github.com/chenzhuoxi/GDUST_timetable_full) — 广科课表 Full 版（Flutter），内置 CAS 登录 + 自动抓取 + 课前提醒
- [GDUST_timetable_lite](https://github.com/chenzhuoxi/GDUST_timetable_lite) — 课表查看工具 Lite 版（Flutter），导入 JSON 即用，更轻量
